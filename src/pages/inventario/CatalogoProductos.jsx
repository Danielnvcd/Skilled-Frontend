...
import {
  ...
  getAlmacenes, getProyectosInventario, exportarProductos,
...
import {
  CHECKBOX_CLS, ubicacionInicial, guardarUbicacion, agruparPorProyecto,
  DetalleCampo, BucketEditor,
...
export default function CatalogoProductos() {
  ...
  useEffect(() => {
    guardarUbicacion({ verTodos, categoria: categoriaFiltro })
  ...
  const aplicarMinimos = async () => {
    ...
    try {
      ...
      toast.error(extractApiError(err, 'No se pudo actualizar el stock mínimo'))
    } finally {
